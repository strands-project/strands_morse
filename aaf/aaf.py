...
docking_station.translate(0.2,0.0,0.235)
...
docking_station_label.translate(0.22,0.0,1.65)
docking_station_label.rotate(1.57,0.0,-1.57)

# Set the environment aaf_outline
model_file=os.path.join(os.path.dirname(os.path.abspath( __file__ )),'data/aaf_slam.blend')
