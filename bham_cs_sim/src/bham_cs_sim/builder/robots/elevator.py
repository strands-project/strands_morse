...
from bham_cs_sim.builder.actuators import Platform,SlidingDoor

class Elevator(Robot):
    """
    """
    def __init__(self, debug = True):
        Robot.__init__(self, 'bham_cs_sim/robots/elevator.blend')
        self.properties(classpath = "bham_cs_sim.robots.elevator.Elevator")
