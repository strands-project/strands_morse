...
# tum_kitchen
robot.translate(x=7.15, y=1.95, z=0.1)
...
docking_station.translate(7, 1.95, 0.285)
...
docking_station_label.translate(6.9, 1.95, 1.75)
docking_station_label.rotate(1.57,0,1.57)

# Set the environment
model_file=os.path.join(os.path.dirname(os.path.abspath( __file__ )),'data/thecollection.blend')
env = Environment(model_file,fastmode=True)
env.place_camera([15.0, 5.0, 9.0])
env.aim_camera([7, 0, 1.7854])
